...
.. Please `view the notes <https://docs.chef.io/upgrade_server_standalone_notes.html>`_ about the standalone |chef server oec| upgrade for any changes that may exist for your upgrade process.
