...
What's New
=====================================================
The following items are new for |chef server oec| 11.2 and/or are changes from previous versions:

* **gather-logs subcommand for the Chef Server** The ``gather-logs`` subcommand will create a tarball of recent log files and system information that can be used to send to |company_name| for support.
