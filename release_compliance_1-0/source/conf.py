...
project = u'Chef Compliance 1.0 Documentation'
...
html_title = "Chef Compliance 1.0 Documentation"
...
html_last_updated_fmt = 'Chef Compliance 1.0'
...
htmlhelp_basename = 'Chef Compliance 1.0 Documentation'
