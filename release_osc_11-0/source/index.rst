...
.. raw:: html
   ...
   &nbsp;&nbsp;&nbsp;   <a href="https://docs.chef.io/release/osc_11-0/install_server.html">Install the Enterprise Chef Server</a> </br>
   &nbsp;&nbsp;&nbsp;   <a href="https://docs.chef.io/release/osc_11-0/api_omnitruck.html">Download the chef-client using the Omnitruck API</a> </br>

The |chef server| can be upgraded:

.. raw:: html

   &nbsp;&nbsp;&nbsp;   <a href="https://docs.chef.io/release/osc_11-0/upgrade_server_open_source.html">Upgrade to Open Source Chef Server 11.0</a> </br>
...
.. raw:: html
   ...
   &nbsp;&nbsp;&nbsp;   <a href="https://docs.chef.io/release/osc_11-0/config_rb_chef_server.html">chef-server.rb</a> </br>

The following command-line tools can be run on the |chef server|:

.. raw:: html

   &nbsp;&nbsp;&nbsp;   <a href="https://docs.chef.io/release/osc_11-0/ctl_chef_server.html">ctl-chef-server</a> </br>
...
.. raw:: html
   ...
   &nbsp;&nbsp;&nbsp;   <a href="https://docs.chef.io/release/osc_11-0/api_chef_server.html">Chef Server API</a> </br>
