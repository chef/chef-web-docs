   ...
   * - Definitions
     - .. tag 4_summary
       ...
       * Automatically supports why-run mode, unlike custom resources
       ...
       .. warning:: Starting with chef-client 12.5, it is recommended to build custom resources instead of definitions and to migrate existing definitions to be custom resources .
