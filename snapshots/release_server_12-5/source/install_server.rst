...
* `Standalone <https://docs.chef.io/release/server_12-5/install_server.html#standalone>`__ (everything on a single machine)
* `High availability <https://docs.chef.io/release/server_12-5/install_server.html#high-availability>`__ (machines configured for front-end and back-end, allowing for failover on the back-end and load-balancing on the front-end, as required)
* `Tiered <https://docs.chef.io/release/server_12-5/install_server.html#tiered-single-backend>`__ (machines configured for front-end and back-end, with a single back-end and load-balancing on the front-end, as required)
...
.. raw:: html
   ...
   &nbsp;&nbsp;&nbsp;   <a href="https://docs.chef.io/release/server_12-5/install_server_ha_aws.html">High Availability using Amazon Web Services</a> </br>
   &nbsp;&nbsp;&nbsp;   <a href="https://docs.chef.io/release/server_12-5/install_server_ha_drbd.html">High Availability using DRBD</a> </br>
...
.. raw:: html
   ...
   &nbsp;&nbsp;&nbsp;   <a href="https://docs.chef.io/release/server_12-5/install_server_tiered.html">Tiered</a> </br>
