...
* The hostname for the Chef server must be an FQDN, including the domain suffix, and must be resolvable by the other backend and frontend servers. See :ref:`Hostnames, FQDNs <install_server_pre-hostnames>` for more information.
...
Firewalls and Ports
-----------------------------------------------------
.. tag server_firewalls_and_ports_12
