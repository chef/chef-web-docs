...
* Optional. A local user account under which services will run, a local user account for PostgreSQL, and a group account under which services will run. See https://docs.chef.io/release/server_12-1/install_server_pre.html#uids-and-gids for more information.
...
.. raw:: html
   ...
   &nbsp;&nbsp;&nbsp;   <a href="https://docs.chef.io/release/server_12-1/install_server_ha_aws.html">High Availability using Amazon Web Services</a> </br>
   &nbsp;&nbsp;&nbsp;   <a href="https://docs.chef.io/release/server_12-1/install_server_ha_drbd.html">High Availability using DRBD</a> </br>
...
.. raw:: html
   ...
   &nbsp;&nbsp;&nbsp;   <a href="https://docs.chef.io/release/server_12-1/install_server_tiered.html">Tiered</a> </br>
