...
``sensitive``
   **Ruby Types:** TrueClass, FalseClass
   ...
   Ensure that sensitive resource data is not logged by the chef-client. Default value: ``false``. This property only applies to the **file** and **template** resources.
...
.. tag recipe_guard_notif_do_not_update_if_already_updated
...
.. tag recipe_guard_notif_ensure_node_can_resolve_host
...
.. tag recipe_guard_notif_prevent_install_on_older_versions
...
.. tag recipe_guard_notif_set_administrator_unless_already_set
...
.. tag recipe_guard_onlyif_certain_packages
...
.. tag recipe_guard_onlyif_remove_recipe
...
.. tag recipe_guard_onlyif_reregister_aspdotnet
