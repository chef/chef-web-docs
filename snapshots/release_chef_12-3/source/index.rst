=====================================================
About chef-client 12.3
=====================================================

.. include:: ../../includes_chef/includes_chef_index.rst

View the :doc:`release notes </release_notes>` for chef-client 12.3.
...
**The Recipe DSL:** :doc:`About the Recipe DSL </dsl_recipe>` --- **Methods:** `attribute? <https://docs.chef.io/release/12-3/dsl_recipe.html#attribute>`_ | `control <https://docs.chef.io/release/12-3/dsl_recipe.html#control>`_ | `control_group <https://docs.chef.io/release/12-3/dsl_recipe.html#control-group>`_ | `cookbook_name <https://docs.chef.io/release/12-3/dsl_recipe.html#cookbook-name>`_ | `data_bag <https://docs.chef.io/release/12-3/dsl_recipe.html#data-bag>`_ | `data_bag_item <https://docs.chef.io/release/12-3/dsl_recipe.html#data-bag-item>`_ | `platform? <https://docs.chef.io/release/12-3/dsl_recipe.html#platform>`_ | `platform_family? <https://docs.chef.io/release/12-3/dsl_recipe.html#platform-family>`_ | `reboot_pending <https://docs.chef.io/release/12-3/dsl_recipe.html#reboot-pending>`_ |  `recipe_name <https://docs.chef.io/release/12-3/dsl_recipe.html#recipe-name>`_ | `registry_data_exists? <https://docs.chef.io/release/12-3/dsl_recipe.html#registry-data-exists>`_ | `registry_get_subkeys <https://docs.chef.io/release/12-3/dsl_recipe.html#registry-get-subkeys>`_ | `registry_get_values <https://docs.chef.io/release/12-3/dsl_recipe.html#registry-get-values>`_ | `registry_has_subkeys? <https://docs.chef.io/release/12-3/dsl_recipe.html#registry-has-subkeys>`_ | `registry_key_exists? <https://docs.chef.io/release/12-3/dsl_recipe.html#registry-key-exists>`_ | `registry_value_exists? <https://docs.chef.io/release/12-3/dsl_recipe.html#registry-value-exists>`_ | `resources <https://docs.chef.io/release/12-3/dsl_recipe.html#resources>`_ | `search <https://docs.chef.io/release/12-3/dsl_recipe.html#search>`_ | `shell_out <https://docs.chef.io/release/12-3/dsl_recipe.html#shell-out>`_ | `shell_out! <https://docs.chef.io/release/12-3/dsl_recipe.html#id2>`_ | `shell_out_with_systems_locale <https://docs.chef.io/release/12-3/dsl_recipe.html#shell-out-with-systems-locale>`_ | `tag <https://docs.chef.io/release/12-3/dsl_recipe.html#tag-tagged-untag>`_ | `tagged? <https://docs.chef.io/release/12-3/dsl_recipe.html#tag-tagged-untag>`_ | `untag <https://docs.chef.io/release/12-3/dsl_recipe.html#tag-tagged-untag>`_ | `value_for_platform <https://docs.chef.io/release/12-3/dsl_recipe.html#value-for-platform>`_ | `value_for_platform_family <https://docs.chef.io/release/12-3/dsl_recipe.html#value-for-platform-family>`_ | `Windows Platform Helpers <https://docs.chef.io/release/12-3/dsl_recipe.html#helpers>`_
