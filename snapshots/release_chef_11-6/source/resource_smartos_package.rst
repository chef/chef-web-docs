...
A **smart_o_s_package** resource block manages a package on a node, typically by installing it. The simplest use of the **smart_o_s_package** resource is:
...
The full syntax for all of the properties that are available to the **smart_o_s_package** resource is:
...
.. tag 6_smartos_package_install

.. To install a package:

.. code-block:: ruby

   smart_o_s_package 'name of package' do
     action :install
   end
