...
.. Please :doc:`view the notes <upgrade_server_standalone_notes>` about the standalone Enterprise Chef upgrade for any changes that may exist for your upgrade process.
