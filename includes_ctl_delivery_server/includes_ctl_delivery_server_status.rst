...
The ``status`` subcommand is used to show the status of all services available to the |delivery| server. The results will vary based on the configuration of a given server. This subcommand has the following syntax:
