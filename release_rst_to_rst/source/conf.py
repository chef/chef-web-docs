...
# The file name suffix for generated RST files.
rst_file_suffix = '.rst'

# The file name suffix for generated links to RST files. The default is the same as rst_file_suffix.
rst_link_suffix = '.rst'

# A function to translate a docname to a filename. By default, returns docname + rst_file_suffix.
# rst_file_transform = ''

# A function to translate a docname to a partial URI. By default, returns docname + rst_link_suffix.
# rst_link_transform = ''
