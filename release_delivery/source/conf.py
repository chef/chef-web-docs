...
project = u'Chef Delivery Documentation'
...
html_last_updated_fmt = 'current version of Chef Delivery'
...
htmlhelp_basename = 'Chef Delivery'
...
latex_documents = [
  ('index', 'Chef Delivery.tex', u'Chef Delivery',
   u'Chef', 'manual'),
]
