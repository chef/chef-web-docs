...
html_last_updated_fmt = 'current version of Supermarket'
...
htmlhelp_basename = 'Supermarket Docs'
...
latex_documents = [
  ('index', 'Supermarket Docs.tex', u'Supermarket Docs',
   u'Supermarket', 'manual'),
]
