  ...
  if (product === 'automate'){
    ...
    $.each(groupedReleases, function(navDate, releases) {
      if ( releases.length > 0 ) {
        ...
        $(".TableOfContents").prepend("<li>" + navDate + "<ul class=\""+ classes + "\">" + releaseList + "</ul></li>");
      }
    });
    $(".TableOfContents").prepend("<strong class = \"release_notes_toc\"><h4>Release Versions</h4></strong>");

  } else {
    $(".TableOfContents").html("<strong class = \"release_notes_toc\"><h4>Release Versions</h4></strong><ul class=\"release-notes-menu\"></ul>");
