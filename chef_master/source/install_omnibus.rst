...
``-P`` (``-project`` on Microsoft Windows)
   The product name to install. A list of valid product names can be found at https://github.com/chef/mixlib-install/blob/master/PRODUCT_MATRIX.md. Default value: ``chef``.
