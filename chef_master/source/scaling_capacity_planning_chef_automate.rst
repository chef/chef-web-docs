...
The following disk and CPU utilization metrics for the visibility feature in |automate| can be used when performing scaling and capacity planning on your |automate| server. 
...
the node object itself (including its attributes), to the |automate| server. Therefore, the storage requirements for 
|automate| depend on your node object size, amount of resources evaluated during a converge, fleet size, and convergence interval.
...
Message Thoroughput
==================================================
On a machine provisioned with 4 CPUs and 16GB RAM (the recommended compute resources for a |automate| Server), 
|automate| is able to reliably process 9000 concurrent converge messages. 
