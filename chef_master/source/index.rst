...
`dsc_script </resource_dsc_script.html>`__ | `windows_env </resource_windows_env.html>`__ | `erl_call </resource_erlang_call.html>`__ | `execute </resource_execute.html>`__ | `file </resource_file.html>`__ | `freebsd_package </resource_freebsd_package.html>`__ | `gem_package </resource_gem_package.html>`__ |
