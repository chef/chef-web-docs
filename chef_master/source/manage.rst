...
The Chef management console provides ways for users to manage `data bags </server_manage_data_bags.html>`__, `environments </server_manage_environments.html>`__, `roles </server_manage_roles.html>`__, `cookbooks </server_manage_cookbooks.html>`__, `clients </server_manage_clients.html>`__, and `managing tags </server_manage_nodes.html#manage-tags.html>`___.
