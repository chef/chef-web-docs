...
The following sections describe configuration steps that should be done after the Chef Infra Server is installed.
...
.. warning:: This option is sometimes necessary when the Chef Infra Server is configured for high availability using DRBD.
