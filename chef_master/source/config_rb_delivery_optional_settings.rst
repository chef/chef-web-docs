...
**The following Elasticsearch options require Chef Automate 1.6.156 or later:**

``elasticsearch['auth_user']``
   The username that Automate will use if you have Elasticsearch X-Pack Basic Authentication enabled on your Elasticsearch cluster. Default value: ``nil``.

``elasticsearch['auth_password']``
   The password that Automate will use if you have Elasticsearch X-Pack Basic Authentication enabled on your Elasticsearch cluster. Default value: ``nil``.
