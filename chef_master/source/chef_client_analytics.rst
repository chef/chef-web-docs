...
This topic discusses the chef-client only from the context of Chef Analytics. For general information about the Chef client, see the `Chef Client Overview </chef_client_overview>`_.
