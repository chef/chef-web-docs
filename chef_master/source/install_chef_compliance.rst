...
#. Run through the setup wizard, and then log in to Chef Compliance webui ``https://<fqdn>`` using a current Chrome or Firefox browser. IE is known to have issues with this UI code and is not recommended.
