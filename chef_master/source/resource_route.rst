...
* ``name`` is the name of the resource block. When name is ``default`` the default gateway is modified and persisted to /etc/sysconfig/network file on RHEL/Centos hosts.
