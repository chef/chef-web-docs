...
be
-----------------------------------------------------
This matcher can be followed by many different comparison operators. Always use numbers (and not strings) for these comparisons.
...
cmp
-----------------------------------------------------
Unlike ``eq``, ``cmp`` is a matcher for less-restrictive comparisons. It will try to fit the actual value to the type to which it is compared. This reduces the need for writing type-casts and resolutions.
...
* Single-value arrays of strings may also be compared to a regular expression:
