...
``-V``, ``--verbose``
   Set for more verbose outputs. Use ``-VV`` for further, increased verbose outputs. Use ``-VVV`` for maximum verbosity, which may be unhelpful for what most users want.
