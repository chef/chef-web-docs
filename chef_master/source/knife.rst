...
.. list-table::
   ...
   * - Subcommand
     - Description
   * - `knife_bootstrap </knife_bootstrap>`_
   ...
   * - `knife configure </knife_configure>`_
   ...
   * - `knife cookbook </knife_cookbook>`_
   ...
   * - `knife cookbook site </knife_cookbook_site>`_
   ...
   * - :`knife data bag </knife_data_bag>`_
   ...
   * - `knife download </knife_download>`_
   ...
   * - `knife environment </knife_environment>`_
   ...
   * - `knife recipe list </knife_recipe_list>`_
   ...
   * - `knife ssl check </knife_ssl_check>`_
   ...
   * - `knife ssl fetch </knife_ssl_fetch>`_
