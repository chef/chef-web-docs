...
[menu]
  [menu.docs]
    ...
    identifier = "chef_infra/chefdk/chef_solo/chef_solo.html About Chef Solo"
    parent = "chef_infra/chefdk/chef_solo"
    weight = 10
+++    

[\[edit on
GitHub\]](https://github.com/chef/chef-web-docs/blob/master/chef_master/source/chef_solo.rst)
