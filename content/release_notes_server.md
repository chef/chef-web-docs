...
- Updated nginx TLS/SSL configuration format to avoid warnings in the log.
...
- Support for TLS/SSL auth between internal Chef Server Services. This includes connections to bifrost and the internal Postgresql server.
...
:   The TLS/SSL versions used by the rabbitmq-management plugin. (See
...
<td>Use to enable TLS/SSL. Default value: <code>false</code>. Must be <code>false</code> when <code>ldap['tls_enabled']</code> is <code>true</code>.</td>
</tr>
<tr>
<td><code>ldap['tls_enabled']</code></td>
<td>Use to enable TLS. When enabled, communication with the LDAP server is done via a secure TLS/SSL connection on a dedicated port. When <code>true</code>, <code>ldap['port']</code> is also set to <code>636</code>. Default value: <code>false</code>. Must be <code>false</code> when <code>ldap['ssl_enabled']</code> is <code>true</code>.</td>
</tr>
</tbody>
</table>
...
setting to first enable TLS/SSL, and then the `ldap['encryption']` setting
