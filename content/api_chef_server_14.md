+++
title = "Chef Infra Server 14 API"
draft = false

aliases = ["/api_chef_server_14.html"]

[menu]
  [menu.infra]
    title = "Chef Infra Server 14 API"
    identifier = "chef_infra/managing_chef_infra_server/api_chef_server.md Chef Infra Server 14 API"
...
{
  "elasticsearch": {
    "url": "https://chef.example/organizations/example-org/cookbook_artifacts/elasticsearch",
    "versions": [
      {
        "url": "https://chef.example/organizations/example-org/cookbook_artifacts/elasticsearch/0bd7539be0434e3355aff8ecccf4543ecf5c4be2",
        "identifier": "0bd7539be0434e3355aff8ecccf4543ecf5c4be2"
      },
      {
        "url": "https://chef.example/organizations/example-org/cookbook_artifacts/elasticsearch/0e1016d364685b87456c648136da04a2559821ec",
...
``` javascript
{
  ...
  "templates": [
    {
      "name": "default.elasticsearch-server.erb",
      "path": "templates/default/default.elasticsearch-server.erb",
  ...
  "metadata": {
    "name": "elasticsearch",
    "description": "Installs and configures Elasticsearch server",
    "long_description": "",
    ...
    "providing": {
      "elasticsearch::cluster": ">= 0.0.0",
      "elasticsearch::community_plugins": ">= 0.0.0",
      "elasticsearch": ">= 0.0.0",
      "elasticsearch::erlang_package": ">= 0.0.0",
      "elasticsearch::esl_erlang_package": ">= 0.0.0",
      "elasticsearch::management_ui": ">= 0.0.0",
      "elasticsearch::mgmt_console": ">= 0.0.0",
      "elasticsearch::plugin_management": ">= 0.0.0",
      "elasticsearch::plugins": ">= 0.0.0",
      "elasticsearch::policies": ">= 0.0.0",
      "elasticsearch::policy_management": ">= 0.0.0",
      "elasticsearch::systemd_limits": ">= 0.0.0",
      "elasticsearch::user_management": ">= 0.0.0",
      "elasticsearch::users": ">= 0.0.0",
      "elasticsearch::vhosts": ">= 0.0.0",
      "elasticsearch::virtualhost_management": ">= 0.0.0"
    },
    "recipes": {
      "elasticsearch": "Install and configure Elasticsearch",
      "elasticsearch::systemd_limits": "Sets up kernel limits (e.g. nofile) for Elasticsearch via systemd",
      "elasticsearch::cluster": "Set up Elasticsearch clustering.",
      "elasticsearch::management_ui": "Sets up Elasticsearch management plugin/UI",
      "elasticsearch::mgmt_console": "Deprecated, alias for elasticsearch::management_ui",
      "elasticsearch::plugins": "Manage plugins with node attributes",
      "elasticsearch::plugin_management": "Deprecated, alias for elasticsearch::plugins",
      "elasticsearch::vhosts": "Manage virtual hosts with node attributes",
      "elasticsearch::virtualhost_management": "Deprecated, alias for elasticsearch::vhosts",
      "elasticsearch::users": "Manage users with node attributes",
      "elasticsearch::user_management": "Deprecated, alias for elasticsearch::users",
      "elasticsearch::policies": "Manage policies with node attributes",
      "elasticsearch::policy_management": "Deprecated, alias for elasticsearch::policies",
      "elasticsearch::erlang_package": "Provisions Erlang via Team Elasticsearch packages",
      "elasticsearch::esl_erlang_package": "Alias for erlang::esl",
      "elasticsearch::community_plugins": ""
    },
    "version": "5.7.7",
    "source_url": "https://github.com/elasticsearch/chef-cookbook",
    "issues_url": "https://github.com/elasticsearch/chef-cookbook/issues",
    "privacy": false,
    "chef_versions": [
    ],
    "ohai_versions": [
...
{"uri":
 ...
 "checksums":
   {"385ea5490c86570c7de71070bce9384a":
     ...
     {"url":
       "https://s3.amazonaws.com/-platform-production-data/organization-(...)",
       "needs_upload":true}
   },
