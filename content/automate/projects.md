...
Ingest rules allow ingested events and nodes to be added to projects. _Node_ corresponds to ingested client run and compliance nodes, and _Event_ corresponds to ingested events on the _Event Feed_ page.
...
The _Project List_ page displays the status of project ingest rules (_No rules_, _Edits pending_, or _Applied_).
...
Stopping a project update early will leave your resources in a bad state. Some resources will be in the correct projects and others won't be. To resolve this, make sure to start another project update.
