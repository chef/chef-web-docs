...
API](/api_omnitruck.html). Additionally, Chef Infra
...
[Omnitruck API](/api_omnitruck.html).
...
-   **SLES 11 EOL**
    ...
    Policy](/platforms.html#platform-end-of-life-policy)
...
-   **chocolatey_feature**
    ...
    documentation](/resource_chocolatey_feauture.html)
...
-   **archive_file resource**
    ...
    [archive_file](/resource_archive_file.html)
...
-   **windows_uac resource**
    ...
    hosts. See the
    [windows_uac](/resource_windows_uac.html)
    documentation for more information.
...
-   **windows_dfs_folder resource**
    ...
    DFS folders. See the
    [windows_dfs_folder](/resource_windows_dfs_folder.html)
    documentation for more information.
...
-   **windows_dfs_namespace resources**
    ...
    [windows_dfs_namespace](/resource_windows_dfs_namespace.html)
    documentation for more information.
...
-   **windows_dfs_server resources**
    ...
    [windows_dfs_server](/resource_windows_dfs_server.html)
    documentation for more information.
...
-   **windows_dns_record resource**
    ...
    records. See the
    [windows_dns_record](/resource_windows_dns_record.html)
    documentation for more information.
...
-   **windows_dns_zone resource**
    ...
    See the
    [windows_dns_zone](/resource_windows_dns_zone.html)
    documentation for more information.
...
-   **snap_package resource**
    ...
    hosts. See the
    [snap_package](/resource_snap_package.html)
    documentation for more information.
...
-   gem_installer_bundler_options: This allows setting additional
...
-   **node.set and node.set_unless**
    ...
    [attribute documentation](/attributes.html) to
...
-   **The \`\`deploy\`\` resource is deprecated**
    ...
    documentation](/deprecations_deploy_resource.html)
    for more information.
...
page](/deprecations_resource_cloning.html) for
further information.
