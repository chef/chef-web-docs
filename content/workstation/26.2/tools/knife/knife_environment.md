...
[menu]
  [menu.workstation_26_2]
    title = "knife environment"
    identifier = "workstation_26_2/tools/knife/reference/knife_environment.md knife environment"
...
{{< readfile file="content/workstation/26.2/reusable/md/knife_environment_summary.md" >}}
...
environment to Chef Infra Server.
...
: The description of the environment. This value populates the description field for the environment on Chef Infra Server.
...
currently available on Chef Infra Server.
