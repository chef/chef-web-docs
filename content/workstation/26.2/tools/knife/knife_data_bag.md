...
[menu]
  [menu.workstation_26_2]
    title = "knife data bag"
    identifier = "workstation_26_2/tools/knife/reference/knife_data_bag.md knife data bag"
...
{{< readfile file="content/workstation/26.2/reusable/md/knife_data_bag_summary.md" >}}
...
: The name of a specific item within a data bag. `DATA_BAG_NAME` may not be `client`, `environment`, `node` or `role`, as these are reserved words for [knife search](/workstation/26.2/tools/knife/knife_search/).
