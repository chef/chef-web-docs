...
[menu.workstation_26_2]
  title = "Upgrade"
  identifier = "workstation_26_2/upgrade"
  weight = 30
+++

Chef Workstation 26.2 and later uses native installers for Debian, RPM, and Windows.
...
- [Set up Workstation](/workstation/26.2/set_up/)
- [Add a license](/workstation/26.2/license/)
