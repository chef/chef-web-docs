...
[menu]
  [menu.workstation_25]
    title = "kitchen.yml"
    identifier = "workstation_25/tools/test_kitchen/config_yml_kitchen.md kitchen.yml"
...
: The Progress Chef license key used for authenticated Chef Infra Client downloads.
  ...
  This setting is required when using Test Kitchen 4.0.0 or later. You can also set this using the `CHEF_LICENSE_KEY` environment variable. For more information, see the [Chef licensing documentation](/licensing/).
