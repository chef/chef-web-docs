...
[menu]
  [menu.workstation_25]
    title = "knife role"
    identifier = "workstation_25/tools/knife/knife_role.md knife role"
...
{{< readfile file="content/workstation/25/reusable/md/knife_role_summary.md" >}}

{{< note >}}

To add a role to a node and then build out the run-list for that node,
use the [knife node](/workstation/25/tools/knife/knife_node/) subcommand and its `run_list add`
argument.
