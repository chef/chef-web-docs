...
[menu]
  [menu.workstation_25]
    title = "knife winrm"
    identifier = "workstation_25/tools/knife/knife_winrm.md knife winrm"
...
Review the list of [common options](/workstation/25/tools/knife/common_options/) available to this (and all) knife subcommands and plugins.
...
{{< readfile file="content/workstation/25/reusable/md/knife_windows_winrm_ports.md" >}}
