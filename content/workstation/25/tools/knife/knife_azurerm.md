...
[menu]
  [menu.workstation_25]
    title = "knife azurerm"
    identifier = "workstation_25/tools/knife/knife_azurerm.md knife azurerm"
...
{{< readfile file="content/workstation/25/reusable/md/knife_azure.md" >}}

{{< note >}}

Review the list of [common options](/workstation/25/tools/knife/common_options/) available to
