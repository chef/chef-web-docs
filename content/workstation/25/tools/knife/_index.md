...
[menu]
  [menu.workstation_25]
    title = "About Knife"
    identifier = "workstation_25/tools/knife/knife.md About Knife"
...
- **[Set up Knife](/workstation/25/tools/knife/set_up/)**: Configure knife to interact with your organization's Chef Infra Server and infrastructure.
- **[Knife Common Options](/workstation/25/tools/knife/common_options/)**: Common options that are available for all knife subcommands.
- **[config.rb](/workstation/25/tools/knife/config_rb/)**: Common options for the `config.rb` file
...
| --- | --- |
| [knife_bootstrap](/workstation/25/tools/knife/knife_bootstrap/) | {{< readfile file="content/workstation/25/reusable/md/knife_bootstrap_summary.md" >}} |
| [knife_client](/workstation/25/tools/knife/knife_client/) | {{< readfile file="content/workstation/25/reusable/md/knife_client_summary.md" >}} |
| [knife configure](/workstation/25/tools/knife/knife_configure/) | {{< readfile file="content/workstation/25/reusable/md/knife_configure_summary.md" >}} |
| [knife cookbook](/workstation/25/tools/knife/knife_cookbook/) | {{< readfile file="content/workstation/25/reusable/md/knife_cookbook_summary.md" >}} |
| [knife data bag](/workstation/25/tools/knife/knife_data_bag/) | {{< readfile file="content/workstation/25/reusable/md/knife_data_bag_summary.md" >}} |
| [knife delete](/workstation/25/tools/knife/knife_delete/) | {{< readfile file="content/workstation/25/reusable/md/knife_delete_summary.md" >}} |
| [knife deps](/workstation/25/tools/knife/knife_deps/) | {{< readfile file="content/workstation/25/reusable/md/knife_deps_summary.md" >}} |
| [knife diff](/workstation/25/tools/knife/knife_diff/) | {{< readfile file="content/workstation/25/reusable/md/knife_diff_summary.md" >}} |
| [knife download](/workstation/25/tools/knife/knife_download/) | {{< readfile file="content/workstation/25/reusable/md/knife_download_summary.md" >}} |
| [knife edit](/workstation/25/tools/knife/knife_edit/) | {{< readfile file="content/workstation/25/reusable/md/knife_edit_summary.md" >}} |
| [knife environment](/workstation/25/tools/knife/knife_environment/) | {{< readfile file="content/workstation/25/reusable/md/knife_environment_summary.md" >}} |
| [knife exec](/workstation/25/tools/knife/knife_exec/) | {{< readfile file="content/workstation/25/reusable/md/knife_exec_summary.md" >}} |
| [knife list](/workstation/25/tools/knife/knife_list/) | {{< readfile file="content/workstation/25/reusable/md/knife_list_summary.md" >}} |
| [knife node](/workstation/25/tools/knife/knife_node/) | {{< readfile file="content/workstation/25/reusable/md/knife_node_summary.md" >}} |
| [knife raw](/workstation/25/tools/knife/knife_raw/) | {{< readfile file="content/workstation/25/reusable/md/knife_raw_summary.md" >}} |
| [knife recipe list](/workstation/25/tools/knife/knife_recipe_list/) | {{< readfile file="content/workstation/25/reusable/md/knife_recipe_list_summary.md" >}} |
| [knife role](/workstation/25/tools/knife/knife_role/) | {{< readfile file="content/workstation/25/reusable/md/knife_role_summary.md" >}} |
| [knife search](/workstation/25/tools/knife/knife_search/) | {{< readfile file="content/workstation/25/reusable/md/knife_search_summary.md" >}} |
| [knife serve](/workstation/25/tools/knife/knife_serve/) | {{< readfile file="content/workstation/25/reusable/md/knife_serve_summary.md" >}} |
| [knife show](/workstation/25/tools/knife/knife_show/) | {{< readfile file="content/workstation/25/reusable/md/knife_show_summary.md" >}} |
| [knife ssh](/workstation/25/tools/knife/knife_ssh/) | {{< readfile file="content/workstation/25/reusable/md/knife_ssh_summary.md" >}} |
| [knife ssl check](/workstation/25/tools/knife/knife_ssl_check/) | {{< readfile file="content/workstation/25/reusable/md/knife_ssl_check_summary.md" >}} |
| [knife ssl fetch](/workstation/25/tools/knife/knife_ssl_fetch/) | {{< readfile file="content/workstation/25/reusable/md/knife_ssl_fetch_summary.md" >}} |
| [knife status](/workstation/25/tools/knife/knife_status/) | {{< readfile file="content/workstation/25/reusable/md/knife_status_summary.md" >}} |
| [knife tag](/workstation/25/tools/knife/knife_tag/) | {{< readfile file="content/workstation/25/reusable/md/knife_tag_summary.md" >}} |
| [knife supermarket](/workstation/25/tools/knife/knife_supermarket/) | Use the `knife supermarket` subcommand to interact with cookbooks that are available in the [Chef Supermarket](https://supermarket.chef.io/). A user account is required for any community actions that write data to this site. The following arguments don't require a user account: `download`, `search`, `install`, and `list`. |
| [knife upload](/workstation/25/tools/knife/knife_upload/) | {{< readfile file="content/workstation/25/reusable/md/knife_upload_summary.md" >}} |
| [knife user](/workstation/25/tools/knife/knife_user/) | {{< readfile file="content/workstation/25/reusable/md/knife_user_summary.md" >}} |
| [knife xargs](/workstation/25/tools/knife/knife_xargs/) | {{< readfile file="content/workstation/25/reusable/md/knife_xargs_summary.md" >}} |
