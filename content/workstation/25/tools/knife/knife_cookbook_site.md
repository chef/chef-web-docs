...
[menu]
  [menu.workstation_25]
    title = "knife cookbook site"
    identifier = "workstation_25/tools/knife/knife_cookbook_site.md knife cookbook site"
...
supermarket](/workstation/25/tools/knife/knife_supermarket/) command.

{{< /warning >}}

{{< warning >}}

{{< readfile file="content/workstation/25/reusable/md/notes_knife_cookbook_site_use_devkit_berkshelf.md" >}}
