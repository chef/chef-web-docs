...
[menu]
  [menu.workstation_25]
    ...
    identifier = "workstation_25/tools/knife/plugins/plugin_knife_custom.md Writing Custom Plugins"
    parent = "workstation_25/tools/knife/plugins"
    weight = 20
+++

<!-- markdownlint-disable-file MD033 MD037 -->

{{< readfile file="content/workstation/25/reusable/md/plugin_knife_summary.md" >}}
