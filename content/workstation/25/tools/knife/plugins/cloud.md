...
[menu]
  [menu.workstation_25]
    title = "Cloud plugins"
    identifier = "workstation_25/tools/knife/plugins/plugin_knife.md Cloud Plugins"
...
- The same [common options](/workstation/25/tools/knife/common_options/) used by knife
