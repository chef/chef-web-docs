...
[menu]
  [menu.workstation_25]
    title = "knife org"
    identifier = "workstation_25/tools/knife/knife_org.md knife org"
...
The knife [common options](/workstation/25/tools/knife/common_options/) are available to this (and all) knife subcommands and plugins.
...
User subcommands or options are added under `knife user`. See the [knife user](/workstation/25/tools/knife/knife_user/) documentation for more information.
