...
- A SHA256 sum of any hostname that you're connecting to with `chef-run`.
- How you connect to a remote host with `chef-run`, either WinRM or SSH.
- Target operating system of any hosts connected to with `chef-run`.
...
You can view the analytics we collect before it's sent.
