...
[cascade]
  [cascade.params]
    swiftype_search_products = ["workstation-26.0"]
    version_selector_product = "workstation"
    version_selector = true
    this_version_text = "Chef Workstation 26.0"
    section_root = "/workstation/26.0"
    menu_id = "workstation_26_0"
    breadcrumbs = true
    st_robots = ''
...
[menu]
  [menu.workstation_26_0]
    title = "About Chef Workstation"
    identifier = "workstation_26_0/about_workstation.md About Chef Workstation"
    weight = 10
+++
...
1. [Install Workstation](/workstation/26.0/install/)
1. [Set up Workstation](/workstation/26.0/set_up/)
1. [Add a license](/workstation/26.0/license/)
1. Optional: [Get started with Workstation](/workstation/26.0/get_started/)
