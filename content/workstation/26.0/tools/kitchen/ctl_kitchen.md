...
[menu]
  [menu.workstation_26_0]
    title = "kitchen executable"
    identifier = "workstation_26_0/tools/test_kitchen/ctl_kitchen.md kitchen executable"
    parent = "workstation_26_0/tools/test_kitchen"
    weight = 20
+++
<!-- markdownlint-disable-file MD024 MD036 MD046-->

{{< readfile file="content/workstation/26.0/reusable/md/ctl_kitchen_summary.md" >}}
...
: Run Test Kitchen against one or more platforms listed in the `kitchen.yml` file. Use `all` to run Test Kitchen against all platforms. Use a Ruby regular expression to glob two or more platforms into a single run.
  ...
  {{< readfile file="content/workstation/26.0/reusable/md/ctl_kitchen_common_option_platforms.md" >}}
...
: Use to specify a remote command to be run with SSH.
...
: Create a RubyGems file, if one doesn't already exist. Default: `false`.
...
: The default provisioner that's used by Test Kitchen.
...
automatically names instances by combining a suite name with a platform name.
...
This subcommand doesn't have any options.
