...
[menu]
  [menu.workstation_26_0]
    title = "knife azurerm"
    identifier = "workstation_26_0/tools/knife/reference/knife_azurerm.md knife azurerm"
...
{{< readfile file="content/workstation/26.0/reusable/md/knife_azure.md" >}}

{{< note >}}

Review the list of [common options](/workstation/26.0/tools/knife/common_options/) available to
...
knife[:azure_subscription_id] # found with: <subscriptionId>
