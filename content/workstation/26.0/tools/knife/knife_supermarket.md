...
[menu]
  [menu.workstation_26_0]
    title = "knife supermarket"
    identifier = "workstation_26_0/tools/knife/reference/knife_supermarket.md knife supermarket"
...
version) has been deprecated and the `--force` option isn't used, knife
...
the user name and API key that's identified in the configuration file
