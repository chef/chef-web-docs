...
[menu]
  [menu.workstation_26_0]
    title = "knife download"
    identifier = "workstation_26_0/tools/knife/reference/knife_download.md knife download"
    parent = "workstation_26_0/tools/knife/reference"
+++
<!-- markdownlint-disable-file MD036 -->

{{< readfile file="content/workstation/26.0/reusable/md/knife_download_summary.md" >}}
...
To download the entire chef-repo from Chef Infra Server, browse to
...
To download the `cookbooks/` directory from Chef Infra Server,
...
To download the `environments/` directory from Chef Infra Server,
browse to the top level of the chef-repo and enter:
...
To download the `roles/` directory from Chef Infra Server, browse to
the top level of the chef-repo and enter:
...
To download all data bags from Chef Infra Server, browse to the top
