...
[menu]
  [menu.workstation_26_0]
    title = "knife user"
    identifier = "workstation_26_0/tools/knife/reference/knife_user.md knife user"
    parent = "workstation_26_0/tools/knife/reference"
+++
<!-- markdownlint-disable-file MD024 MD036 -->

{{< readfile file="content/workstation/26.0/reusable/md/knife_user_summary.md" >}}
...
: The path to a file that contains the public key. If this option isn't specified, Chef Infra Server will generate a public/private key pair.
...
update Chef Infra Server with those changes.
...
The public key will be stored on Chef Infra Server and the private
