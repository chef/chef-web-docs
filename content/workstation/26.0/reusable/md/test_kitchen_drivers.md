...
- **[kitchen-azurerm](/workstation/26.0/tools/kitchen/drivers/azurerm/)**: Provisions virtual machines on Microsoft Azure.
- **[kitchen-digitalocean](/workstation/26.0/tools/kitchen/drivers/digitalocean/)**: Provisions droplets on DigitalOcean. This driver ships with Chef Workstation.
- **[kitchen-dokken](/workstation/26.0/tools/kitchen/drivers/dokken/)**: Runs fast cookbook tests using Docker. This driver ships with Chef Workstation.
- **[kitchen-ec2](/workstation/26.0/tools/kitchen/drivers/ec2/)**: Provisions instances on Amazon EC2. This driver ships with Chef Workstation.
- **[kitchen-google](/workstation/26.0/tools/kitchen/drivers/google/)**: Provisions instances on Google Compute Engine. This driver ships with Chef Workstation.
- **[kitchen-hyperv](/workstation/26.0/tools/kitchen/drivers/hyperv/)**: Provisions virtual machines on Microsoft Hyper-V. This driver ships with Chef Workstation.
- **[kitchen-openstack](/workstation/26.0/tools/kitchen/drivers/openstack/)**: Provisions instances on OpenStack. This driver ships with Chef Workstation.
- **[kitchen-vagrant](/workstation/26.0/tools/kitchen/drivers/vagrant/)**: Provisions local virtual machines with HashiCorp Vagrant. This driver ships with Chef Workstation.
- **[kitchen-vcenter](/workstation/26.0/tools/kitchen/drivers/vcenter/)**: Provisions virtual machines on VMware vCenter.
- **[kitchen-vra](/workstation/26.0/tools/kitchen/drivers/vra/)**: Provisions machines through VMware vRealize Automation.
