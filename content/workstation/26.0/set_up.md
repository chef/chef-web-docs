...
[menu]
  [menu.workstation_26_0]
    title = "Set up"
    identifier = "workstation_26_0/setup.md Set Up Chef Workstation"
    weight = 40
+++
...
Use the [chef generate repo]({{< relref "/workstation/26.0/tools/ctl_chef.md#chef-generate-repo" >}}) command to create your Chef Infra repository. For example, to create a repository called `chef-repo`:
...
- [Knife setup documentation](/workstation/26.0/tools/knife/knife_setup/)
- [Knife `config.rb` documentation](/workstation/26.0/tools/knife/config_rb)
- [`knife ssl fetch` documentation](/workstation/26.0/tools/knife/knife_ssl_fetch/)
- [`knife ssl check` documentation](/workstation/26.0/tools/knife/knife_ssl_check/)
