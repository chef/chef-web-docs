...
Use the [chef generate repo]({{< relref "/workstation/26.1/tools/ctl_chef.md#chef-generate-repo" >}}) command to create your Chef Infra repository. For example, to create a repository called `chef-repo`:
