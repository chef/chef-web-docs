...
[cascade]
  [cascade.params]
    swiftype_search_products = ["workstation-26.1"]
    version_selector_product = "workstation"
    version_selector = true
    this_version_text = "Chef Workstation 26.1"
    section_root = "/workstation/26.1"
    menu_id = "workstation_26_1"
    breadcrumbs = true
    st_robots = ''
...
[menu]
  [menu.workstation_26_1]
    title = "About Chef Workstation"
    identifier = "workstation_26_1/about_workstation.md About Chef Workstation"
    weight = 10
+++
...
1. [Install Workstation](/workstation/26.1/install/)
1. [Set up Workstation](/workstation/26.1/set_up/)
1. [Add a license](/workstation/26.1/license/)
1. Optional: [Get started with Workstation](/workstation/26.1/get_started/)
