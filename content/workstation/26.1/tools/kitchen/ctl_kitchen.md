...
[menu]
  [menu.workstation_26_1]
    title = "kitchen executable"
    identifier = "workstation_26_1/tools/test_kitchen/ctl_kitchen.md kitchen executable"
    parent = "workstation_26_1/tools/test_kitchen"
    weight = 20
+++
<!-- markdownlint-disable-file MD024 MD036 MD046-->

{{< readfile file="content/workstation/26.1/reusable/md/ctl_kitchen_summary.md" >}}
...
: Run Test Kitchen against one or more platforms listed in the `kitchen.yml` file. Use `all` to run Test Kitchen against all platforms. Use a Ruby regular expression to glob two or more platforms into a single run.
  ...
  {{< readfile file="content/workstation/26.1/reusable/md/ctl_kitchen_common_option_platforms.md" >}}
