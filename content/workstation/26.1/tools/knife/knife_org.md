...
[menu]
  [menu.workstation_26_1]
    title = "knife org"
    identifier = "workstation_26_1/tools/knife/reference/knife_org.md knife org"
...
The knife [common options](/workstation/26.1/tools/knife/common_options/) are available to this (and all) knife subcommands and plugins.
...
User subcommands or options are added under `knife user`. See the [knife user](/workstation/26.1/tools/knife/knife_user/) documentation for more information.
