...
[menu]
  [menu.workstation_26_1]
    title = "Set up knife"
    identifier = "workstation_26_1/tools/knife/knife_setup.md Setting up knife"
...
Add knife profiles to the `.chef/credentials` file in your home directory. The `credentials` file is TOML formatted. Each profile is a separate table with a name of your choice, followed by `key = value` pairs. The keys correspond to any setting permitted in the [config.rb](/workstation/26.1/tools/knife/config_rb/) file.
...
For a complete list of configuration options, see the [config.rb documentation](/workstation/26.1/tools/knife/config_rb/).
