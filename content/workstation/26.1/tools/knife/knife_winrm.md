...
[menu]
  [menu.workstation_26_1]
    title = "knife winrm"
    identifier = "workstation_26_1/tools/knife/reference/knife_winrm.md knife winrm"
...
Review the list of [common options](/workstation/26.1/tools/knife/common_options/) available to this (and all) knife subcommands and plugins.
...
{{< readfile file="content/workstation/26.1/reusable/md/knife_windows_winrm_ports.md" >}}
