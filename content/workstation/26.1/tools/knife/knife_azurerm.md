...
[menu]
  [menu.workstation_26_1]
    title = "knife azurerm"
    identifier = "workstation_26_1/tools/knife/reference/knife_azurerm.md knife azurerm"
...
{{< readfile file="content/workstation/26.1/reusable/md/knife_azure.md" >}}

{{< note >}}

Review the list of [common options](/workstation/26.1/tools/knife/common_options/) available to
