...
[menu]
  [menu.workstation_26_1]
    title = "knife node"
    identifier = "workstation_26_1/tools/knife/reference/knife_node.md knife node"
...
{{< readfile file="content/workstation/26.1/reusable/md/knife_node_summary.md" >}}
...
{{< readfile file="content/workstation/26.1/reusable/md/knife_common_windows_quotes.md" >}}

{{< /warning >}}

{{< note >}}

{{< readfile file="content/workstation/26.1/reusable/md/knife_common_windows_quotes_module.md" >}}
