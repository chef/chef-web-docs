...
[menu]
  [menu.workstation_26_1]
    title = "knife windows"
    identifier = "workstation_26_1/tools/knife/reference/knife_windows.md knife windows"
...
Ensure that the Windows Firewall is configured to allow WinRM connections between the workstation and Chef Infra Server. For example:
...
: The thumbprint of the SSL certificate. Required when the `--cert-install` option isn't part of a command.
