...
[menu]
  [menu.workstation_26_1]
    title = "knife xargs"
    identifier = "workstation_26_1/tools/knife/reference/knife_xargs.md knife xargs"
    parent = "workstation_26_1/tools/knife/reference"
+++
<!-- markdownlint-disable-file MD036 -->

{{< readfile file="content/workstation/26.1/reusable/md/knife_xargs_summary.md" >}}
...
: Prevent changes from being uploaded to Chef Infra Server. Default: `false`.
...
: Define a string that's to be used to replace all occurrences o file name. Default: `nil`.

`-J REPLACE_STRING`, `--replace-first REPLACE_STRING`

: Define a string that's to be used to replace the first occurrence of a file name. Default: `nil`.
...
: One (or more) patterns for a command line. If this option isn't specified, a list of patterns may be expected on standard input. Default: `nil`.
