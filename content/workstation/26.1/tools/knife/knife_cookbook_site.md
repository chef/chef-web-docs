...
[menu]
  [menu.workstation_26_1]
    title = "knife cookbook site"
    identifier = "workstation_26_1/tools/knife/reference/knife_cookbook_site.md knife cookbook site"
...
supermarket](/workstation/26.1/tools/knife/knife_supermarket/) command.

{{< /warning >}}

{{< warning >}}

{{< readfile file="content/workstation/26.1/reusable/md/notes_knife_cookbook_site_use_devkit_berkshelf.md" >}}
...
If this value isn't specified, knife will use
...
been deprecated and the `--force` option isn't used, knife will alert
...
: The version of a cookbook to be downloaded. If a cookbook has only one version, this option doesn't need to be specified. If a cookbook has more than one version and this option isn't specified, the most recent version of the cookbook is downloaded.
...
: The version of the cookbook to be installed. If a version isn't specified, the most recent version of the cookbook is installed.
...
Use the `share` argument to add a cookbook to the [Chef Supermarket](https://supermarket.chef.io/cookbooks). This action will require a user account and a certificate for [Chef Supermarket](https://supermarket.chef.io/). By default, knife will use the user name and API key that's identified in the configuration file used during the upload; otherwise these values must be specified on the command line or in an alternate configuration file. If a cookbook already exists on the [Chef Supermarket](https://supermarket.chef.io/cookbooks), then only an owner or maintainer of that cookbook can make updates.
