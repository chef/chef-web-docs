...
[menu]
  [menu.workstation_26_1]
    title = "knife role"
    identifier = "workstation_26_1/tools/knife/reference/knife_role.md knife role"
...
{{< readfile file="content/workstation/26.1/reusable/md/knife_role_summary.md" >}}

{{< note >}}

To add a role to a node and then build out the run-list for that node,
use the [knife node](/workstation/26.1/tools/knife/knife_node/) subcommand and its `run_list add`
argument.
