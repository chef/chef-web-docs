+++
title = "Chef InSpec CLI"
draft = false

[menu]
  [menu.inspec]
    title = "Chef InSpec CLI"
    identifier = "inspec/reference/cli.md Chef InSpec CLI"
    parent = "inspec/reference"
    weight = 10
+++

Use the Chef InSpec CLI to run tests and audits against targets using local, SSH, WinRM, or Docker connections.
