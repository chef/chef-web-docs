...
[menu]
  [menu.docs]
    title = "knife exec"
    identifier = "knife exec/knife_exec.html"
    parent = "chefdk/knife"
    weight = 170
+++    
...
> -   When the chef-shell DSL is available, the Chef Infra Client DSL
>     will not be (unless the management workstation is also a Chef
>     Infra Client). Without the Chef Infra Client DSL, a bash block
>     cannot be used to run bash commands.
