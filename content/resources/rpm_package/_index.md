...
- markdown: 'Use the **rpm_package** resource to manage packages for the RPM Package
...
handler_types: false
syntax_description: 'A **rpm_package** resource block manages a package on a node,
  typically by installing it. The simplest use of the **rpm_package** resource is:'
syntax_code_block: rpm_package 'package_name'
syntax_properties_list: null
syntax_full_code_block: "rpm_package 'name' do\n  allow_downgrade      true, false\
...
- example_heading: Install a package
  text_blocks:
  - code_block: "rpm_package 'name of package' do\n  action :install\nend"
