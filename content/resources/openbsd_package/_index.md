...
menu:
  docs:
    ...
    identifier: chef_infra/cookbook_reference/resources/resource_openbsd_package.md
      openbsd_package
...
syntax_description: 'A **openbsd_package** resource block manages a package on a node,
  typically by installing it. The simplest use of the **openbsd_package** resource
  is:'
syntax_code_block: openbsd_package 'package_name'
