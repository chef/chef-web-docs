...
menu:
  docs:
    ...
    identifier: chef_infra/cookbook_reference/resources/resource_solaris_package.md
      solaris_package
...
syntax_description: 'A **solaris_package** resource block manages a package on a node,
  typically by installing it. The simplest use of the **solaris_package** resource
  is:'
syntax_code_block: solaris_package 'package_name'
