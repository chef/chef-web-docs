...
:   Enable or disable TLS/SSL verification for the connection to the Chef Infra
Server. Valid settings: `:verify_none` and `:verify_peer`. Default value: `:verify_none`

`trusted_certs_dir`

:   Path to a directory containing trusted TLS/SSL certificates for verification
