...
[menu]
  [menu.docs]
    title = "kitchen (executable)"
    identifier = "kitchen (executable)/ctl_kitchen.html"
    parent = "chefdk/test kitchen"
    weight = 20
+++    

[\[edit on
GitHub\]](https://github.com/chef/chef-web-docs/blob/master/chef_master/source/ctl_kitchen.rst)
...
:   Run Test Kitchen against one or more platforms listed in the
    ...
    {{% ctl_kitchen_common_option_platforms %}}
