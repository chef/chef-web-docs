...
[menu]
  [menu.docs]
    ...
    identifier = "disaster recovery/delivery_server_disaster_recovery.html"
    parent = "chef automate 1/managing the server"
    weight = 30
+++    

[\[edit on
GitHub\]](https://github.com/chef/chef-web-docs/blob/master/chef_master/source/delivery_server_disaster_recovery.rst)
