...
2. Add the following settings to the `/etc/opscode/chef-server.rb`
    ...
    {{< readfile file="layouts/shortcodes/chef-server/config_rb_server_settings_ldap.md" >}}
...
3. {{< readfile file="layouts/shortcodes/chef-server/install_chef_server_reconfigure.md" >}}
