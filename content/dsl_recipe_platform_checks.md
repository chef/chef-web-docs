+++
title = "Chef Infra DSL: Platform Checks"
draft = false

[menu]
  [menu.docs]
    title = "Platform Checks"
    identifier = "chef_infra/cookbook_reference/recipe_dsl/dsl_recipe_platform_checks.md DSL Overview"
    parent = "chef_infra/cookbook_reference/recipe_dsl"
    weight = 120
+++

[\[edit on GitHub\]](https://github.com/chef/chef-web-docs/blob/master/content/dsl_recipe_platform_checks.md)
