...
- Added the kitchen-omnibus-chef gem, which provides the Chef provisioner for Test Kitchen and supports authenticated downloads from the Chef downloads API.
