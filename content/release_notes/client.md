...
## Chef Infra Client 18.11.7

Release date: July xx, 2026

### Compliance Phase Improvements
- Fixed an issue where the Compliance Phase ran twice when a reboot was scheduled during a Chef Infra Client run. [#15997](https://github.com/chef/chef/pull/15997)

## New Resources
- Added a recipe for chrony to update Kitchen tests in the CI pipeline. [#15739](https://github.com/chef/chef/pull/15739)
...
- Pinned Habitat version to 1.6 to avoid HAB_AUTH_TOKEN errors. [#15736](https://github.com/chef/chef/pull/15736)
- Fixed an issue where the lazy block for content was evaluated more than once. [#15715](https://github.com/chef/chef/pull/15715)
...
- Fixed an issue where invalid TOML in unit tests caused failures. [#15841](https://github.com/chef/chef/pull/15841)
...
- Kept Chef-18 on inspec-core-bin ~> 5.0 and tomlrb ~> 1.0. [#15858](https://github.com/chef/chef/pull/15858)
...
- Fixed an issue where the chocolatey resource download failed under PowerShell 5.1. [#15925](https://github.com/chef/chef/pull/15925)
- Fixed an issue where Fedora 42 and openSUSE Leap 15 CI tests failed (cherry-pick from #15902). [#15932](https://github.com/chef/chef/pull/15932)
- Pinned ntp and openssh cookbook versions to prevent CI breakage. [#15931](https://github.com/chef/chef/pull/15931)
- Updated pry-stack_explorer from 0.6.2 to 0.6.3. [#15877](https://github.com/chef/chef/pull/15877)
- Updated danger/danger-js from 11.3.1 to 13.0.5. [#15959](https://github.com/chef/chef/pull/15959)
- Updated streetsidesoftware/cspell-action from 2.12.0 to 8.4.0. [#15955](https://github.com/chef/chef/pull/15955)
- Corrected the `rest_resource` DSL. [#15970](https://github.com/chef/chef/pull/15970)
...
- Fixed an issue where reline 0.3.1 had a keyboard bug. [#15963](https://github.com/chef/chef/pull/15963)
...
- Updated actions/checkout from 5 to 6. [#15954](https://github.com/chef/chef/pull/15954)
- Locked Gemfile to pry-byebug 3.11. [#15944](https://github.com/chef/chef/pull/15944)
- Backported sugarjar config to chef-18. [#15946](https://github.com/chef/chef/pull/15946)
- Updated wechuli/allcheckspassed from 1 to 2. [#15956](https://github.com/chef/chef/pull/15956)
- Fixed an issue where trusted certs tests failed intermittently; local resources are now used instead of cloud-based options. [#15961](https://github.com/chef/chef/pull/15961)
- Optimized dnf_command to reduce shell_out calls. [#15971](https://github.com/chef/chef/pull/15971)
- Added DNF5 support to the dnf_package provider. [#16007](https://github.com/chef/chef/pull/16007)
...
- Backported AlmaLinux 10 chrony exemption. [#16032](https://github.com/chef/chef/pull/16032)
- Fixed an issue where `authenticator.retrieve_certificate_key` intermittently raised `NoMethodError` on Windows. [#16076](https://github.com/chef/chef/pull/16076)
- Limited excessive output from template errors (#16073). [#16087](https://github.com/chef/chef/pull/16087)
- Disabled chrony kitchen tests for Rocky Linux 10. [#16084](https://github.com/chef/chef/pull/16084)
...
- Updated actions/labeler from 6.0.1 to 6.1.0. [#15990](https://github.com/chef/chef/pull/15990)
- Updated train-core from 3.16.3 to 3.16.5. [#16103](https://github.com/chef/chef/pull/16103)
- Updated danger/danger-js from 13.0.5 to 13.0.8. [#16124](https://github.com/chef/chef/pull/16124)
...
- Updated InSpec to the latest version. [#16142](https://github.com/chef/chef/pull/16142)
- Updated diff-lcs requirement from >= 1.2.4, != 1.4.0, < 1.6.0 to >= 1.2.4, != 1.4.0, < 2.1.0. [#15826](https://github.com/chef/chef/pull/15826)


### Packaging
- Removed release notes actions from Chef 18. [#15546](https://github.com/chef/chef/pull/15546)
- Updated the GitHub workflow actions for SBOM and related checks. [#15734](https://github.com/chef/chef/pull/15734)
- Fixed an issue where Chef-18 CI failed by updating Black Duck scanning. [#15743](https://github.com/chef/chef/pull/15743)
- Moved the DCO check to GitHub Actions. [#15750](https://github.com/chef/chef/pull/15750)
- Fixed an issue where `platform_family` matches were incorrect. [#15742](https://github.com/chef/chef/pull/15742)
- Backported Dependabot fixes to chef-18 and made gemspec loading more deterministic. [#15789](https://github.com/chef/chef/pull/15789)
- Disabled Expeditor gem bumps on chef-18 because they were creating confusion and delay. [#15843](https://github.com/chef/chef/pull/15843)
- Moved Omnibus to a privatization submodule. [#15659](https://github.com/chef/chef/pull/15659)
- Removed Code Climate from chef-18. [#15939](https://github.com/chef/chef/pull/15939)
- Prevented Buildkite time from being wasted on GitHub-only changes. [#15949](https://github.com/chef/chef/pull/15949)
- Updated CODEOWNERS on chef-18. [#15948](https://github.com/chef/chef/pull/15948)
- Upgraded the GH labeler. [#15960](https://github.com/chef/chef/pull/15960)
- Fixed an issue where kitchen tests for nscd and git cookbooks failed. [#16010](https://github.com/chef/chef/pull/16010)
- Removed kernel 2 support from testing. [#15973](https://github.com/chef/chef/pull/15973)
- Removed unused Dependabot config on chef-18. [#15968](https://github.com/chef/chef/pull/15968)
- Community omnibus - Added a How To after moving it to a submodule [#16008](https://github.com/chef/chef/pull/16008)
- Added `git safe.directory` to the Habitat Linux plan `do_download` step. [#16121](https://github.com/chef/chef/pull/16121)
- Removed Chef-PowerShell from Habitat. [#16092](https://github.com/chef/chef/pull/16092)
- Re-added AIX support for Chef 18 Omnibus builds. [#16109](https://github.com/chef/chef/pull/16109)

### Bug fixes
- Fixed an issue where the `archive_file` resource was vulnerable to path traversal. [#16119](https://github.com/chef/chef/pull/16119)
...
### Security
- Updated aws-sdk-s3 for CVE-2025-14762. [#15848](https://github.com/chef/chef/pull/15848)
- Updated rack to 3.2.6. [#15854](https://github.com/chef/chef/pull/15854)
- Documented CVE PR label requirements. [#16034](https://github.com/chef/chef/pull/16034)
- Updated rack through Chef-Zero. [#16054](https://github.com/chef/chef/pull/16054)
- Updated faraday to 2.14.3 to address a CVE. [#16154](https://github.com/chef/chef/pull/16154)
