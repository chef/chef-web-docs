...
- **Connector Management**: Connector Management is now available in the Chef 360 Platform UI.
  Administrators can discover, view, and manage the lifecycle state and status of connectors (outposts) directly from the platform.

- **SaaS tenant lifecycle controls**: Platform administrators can now disable or enable tenants.
  Disabling a tenant halts all tenant-scoped background activity and blocks API access with explicit error messaging.
...
<!-- TODO: verify - the source draft listed chef-360 as version 1.7.1; confirm whether the correct version is 1.7.2 -->
