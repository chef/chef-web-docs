...
Before upgrading to Chef 360 Platform 1.7.3, you must be running at least version 1.7.1. For more information, see the [supported upgrade path](/admin_console/update/).
