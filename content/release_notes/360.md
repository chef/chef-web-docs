...
- Added Chef Declarative State Management (DSM) integration and migration improvements, including new import services, workers, and CLIs. For DSM, knife commands for organizations, users, and ACLs are now replaced by Chef 360 CLI commands.
