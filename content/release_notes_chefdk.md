...
15.2 Release
Notes](/release_notes.html#chef-infra-client-15-2)
...
accepting the [Chef
EULA](/chef_license.html#chef-eula). See the
...
Notes](/release_notes.html#chef-infra-client-15-0-293)
for more details.
...
-   Support for accepting the Chef 15 license in Test Kitchen runs. See
    [Accepting the Chef
    License](/chef_license_accept.html) for usage
    details.
...
notes](/release_notes.html#whats-new-in-14-12) for
...
Notes](/release_notes.html) for all the details of
this new release.
