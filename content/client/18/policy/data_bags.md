...
{{< readfile file="content/client/18/reusable/md/data_bag_item.md" >}}

## Encrypt a data bag item

{{< readfile file="content/client/18/reusable/md/data_bag_encryption.md" >}}
...
{{< readfile file="content/client/18/reusable/md/data_bag_encryption_secret_key.md" >}}
...
{{< readfile file="content/client/18/reusable/md/workstation/knife_data_bag_edit.md" >}}

{{< readfile file="content/client/18/reusable/md/workstation/knife_data_bag_edit_item.md" >}}
...
- `data_bag(bag)`, where `bag` specifies the name of the data bag.
- `data_bag_item('bag_name', 'item', 'secret')`, where `bag` specifies the
    name of the data bag and `item` specifies the name of the data bag item. If
