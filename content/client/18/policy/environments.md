...
`default`
: {{< readfile file="content/client/18/reusable/md/node_attribute_type_default.md" >}}

`override`
: {{< readfile file="content/client/18/reusable/md/node_attribute_type_override.md" >}}
...
{{< readfile file="content/client/18/reusable/md/chef_solo_environments.md" >}}
