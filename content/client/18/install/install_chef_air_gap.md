...
1. {{< readfile file="content/client/18/reusable/md/server/install_chef_server_install_package.md" >}}
...
1. {{< readfile file="content/client/18/reusable/md/server/ctl_chef_server_user_create_admin.md">}}

1. {{< readfile file="content/client/18/reusable/md/server/ctl_chef_server_org_create_summary.md">}}
...
1. Update the `/etc/opscode/chef-server.rb` configuration file.
    ...
    {{< readfile file="content/client/18/reusable/md/server/config_ocid_application_hash_supermarket.md" >}}
...
1. Retrieve Supermarket's OAuth 2.0 client credentials:
    ...
    supermarket](/server/ctl_chef_server/#ctl-chef-server-oc-id-show-app)
