...
{{< readfile file="content/client/18/reusable/md/resource_log_syntax.md" >}}
...
{{< readfile file="content/client/18/reusable/md/resource_log_properties.md" >}}
...
{{< readfile file="content/client/18/reusable/md/resource_log_set_debug.md" >}}
...
{{< readfile file="content/client/18/reusable/md/handler.md" >}}

{{< readfile file="content/client/18/reusable/md/handler_types.md" >}}

Read more [about exception, report, and start handlers](/client/18/features/handlers/).

### chef-shell

{{< readfile file="content/client/18/reusable/md/chef_shell_summary.md" >}}

{{< readfile file="content/client/18/reusable/md/chef_shell_modes.md" >}}

#### Configure

{{< readfile file="content/client/18/reusable/md/chef_shell_config.md" >}}

#### chef-shell.rb

{{< readfile file="content/client/18/reusable/md/chef_shell_config_rb.md" >}}

#### Run as a Chef Infra Client

{{< readfile file="content/client/18/reusable/md/chef_shell_run_as_chef_client.md" >}}

#### Manage

{{< readfile file="content/client/18/reusable/md/chef_shell_manage.md" >}}

### breakpoint Resource

{{< readfile file="content/client/18/reusable/md/chef_shell_breakpoints.md" >}}
...
{{< readfile file="content/client/18/reusable/md/chef_shell_step_through_run_list.md" >}}

### Debug Existing Recipe

{{< readfile file="content/client/18/reusable/md/chef_shell_debug_existing_recipe.md" >}}

### Advanced Debugging

{{< readfile file="content/client/18/reusable/md/chef_shell_advanced_debug.md" >}}
...
See [chef-solo (executable)](/client/18/features/chef_solo/ctl_chef_solo/) for complete CTL documentation.

{{< readfile file="content/client/18/reusable/md/chef_solo_summary.md" >}}
