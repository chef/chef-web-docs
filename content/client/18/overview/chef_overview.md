...
{{< readfile file="content/client/18/reusable/md/chef.md" >}}

- **Chef Workstation** is the location where users interact with Chef
    Infra. With Chef Workstation, users can author and test
    [cookbooks](/client/18/cookbooks/) using tools such as [Test
    Kitchen](https://docs.chef.io/workstation/25/tools/kitchen/) and interact with the Chef Infra Server
    using the [knife](https://docs.chef.io/workstation/25/tools/knife/) and [chef](https://docs.chef.io/workstation/25/tools/ctl_chef/) command
    line tools.
...
<td><p>{{< readfile file="content/client/18/reusable/md/node.md" >}}</p></td>
</tr>
<tr>
...
<tr>
<td><p><img src="/images/icon_workstation.svg" class="align-center" width="130" alt="" /></p></td>
<td>{{< readfile file="content/client/18/reusable/md/workstation/chef_workstation.md" >}}</td>
</tr>
<tr>
...
<td>{{< readfile file="content/client/18/reusable/md/workstation/test_kitchen.md" >}}</td>
</tr>
<tr>
<td><p><img src="/images/icon_chefspec.svg" class="align-center" width="130" alt="" /></p></td>
<td>{{< readfile file="content/client/18/reusable/md/chefspec_summary.md" >}}</td>
</tr>
</tbody>
</table>
...
{{< readfile file="content/client/18/reusable/md/cookbooks_summary.md" >}}
...
<td>{{< readfile file="content/client/18/reusable/md/cookbooks_attribute.md" >}}</td>
</tr>
<tr>
<td><p><img src="/images/icon_cookbook_files.svg" class="align-center" width="130" alt="" /></p></td>
<td>{{< readfile file="content/client/18/reusable/md/resource_cookbook_file_summary.md" >}}</td>
</tr>
<tr>
<td><p><img src="/images/icon_cookbook_libraries.svg" class="align-center" width="130" alt="" /></p></td>
<td>{{< readfile file="content/client/18/reusable/md/libraries_summary.md" >}}</td>
</tr>
<tr>
<td><p><img src="/images/icon_cookbook_metadata.svg" class="align-center" width="130" alt="" /></p></td>
<td>{{< readfile file="content/client/18/reusable/md/cookbooks_metadata.md" >}}</td>
</tr>
<tr>
<td><p><img src="/images/icon_cookbook_recipes.svg" class="align-center" width="130" alt="" /></p></td>
<td><p>{{< readfile file="content/client/18/reusable/md/cookbooks_recipe.md" >}}</p>
...
<p>{{< readfile file="content/client/18/reusable/md/infra_lang_summary.md" >}}</p></td>
</tr>
<tr>
<td><p><img src="/images/icon_cookbook_resources.svg" class="align-center" width="130" alt="" /></p></td>
<td><p>{{< readfile file="content/client/18/reusable/md/resources_common.md" >}}</p>
...
<td>{{< readfile file="content/client/18/reusable/md/template.md" >}}</td>
</tr>
<tr>
...
{{< readfile file="content/client/18/reusable/md/node.md" >}}

### Node Types

{{< readfile file="content/client/18/reusable/md/node_types.md" >}}
...
<tr>
<td><p><img src="/images/icon_chef_client.svg" class="align-center" width="130" alt="" /></p></td>
<td><p>{{< readfile file="content/client/18/reusable/md/chef_client_summary.md" >}}</p>
<p>{{< readfile file="content/client/18/reusable/md/security_key_pairs_chef_client.md" >}}</p></td>
</tr>
<tr>
<td><p><img src="/images/icon_ohai.svg" class="align-center" width="130" alt="" /></p></td>
<td>{{< readfile file="content/client/18/reusable/md/ohai_summary.md" >}}</td>
</tr>
</tbody>
</table>
...
{{< readfile file="content/client/18/reusable/md/server/chef_server.md" >}}
...
<td>{{< readfile file="content/client/18/reusable/md/search.md" >}}</td>
</tr>
<tr>
<td><p><img src="/images/icon_manage.svg" class="align-center" width="130" alt="" /></p></td>
<td>{{< readfile file="content/client/18/reusable/md/chef_manager.md" >}}</td>
</tr>
<tr>
<td><p><img src="/images/icon_data_bags.svg" class="align-center" width="130" alt="" /></p></td>
<td>{{< readfile file="content/client/18/reusable/md/data_bag.md" >}}</td>
</tr>
<tr>
...
{{< readfile file="content/client/18/reusable/md/policy_summary.md" >}}
...
<td>{{< readfile file="content/client/18/reusable/md/role.md" >}}</td>
</tr>
<tr>
<td><p><img src="/images/icon_environments.svg" class="align-center" width="130" alt="" /></p></td>
<td>{{< readfile file="content/client/18/reusable/md/environment.md" >}}</td>
</tr>
<tr>
<td><p><img src="/images/icon_cookbook_versions.svg" class="align-center" width="130" alt="" /></p></td>
<td>{{< readfile file="content/client/18/reusable/md/cookbooks_version.md" >}}</td>
</tr>
<tr>
<td><p><img src="/images/icon_run_lists.svg" class="align-center" width="130" alt="" /></p></td>
<td>{{< readfile file="content/client/18/reusable/md/node_run_list.md" >}}</td>
</tr>
</tbody>
</table>
