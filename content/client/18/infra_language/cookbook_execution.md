...
Use the `node` method, often referred to as the node object, to access data collected on the system through [Ohai](/client/18/features/ohai/) as well as node attributes set in cookbooks or Policyfiles.
