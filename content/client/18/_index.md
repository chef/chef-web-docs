...
For detailed information, see [About the Compliance Phase](/client/18/features/chef_compliance_phase/).
...
For more details and setup instructions, see the [Agentless documentation](/client/18/features/agentless/).
