...
{{< readfile file="content/client/18/reusable/md/ohai_summary.md" >}}
...
{{< readfile file="content/client/18/reusable/md/notes_see_attributes_overview.md" >}}

{{< /note >}}

{{< readfile file="content/client/18/reusable/md/ohai_automatic_attribute.md" >}}

### Get a list of automatic attributes for a node

{{< readfile file="content/client/18/reusable/md/ohai_attribute_list.md" >}}

### Attributes Blocklist

{{< warning >}}

{{< readfile file="content/client/18/reusable/md/node_attribute_blocklist_warning.md" >}}

{{< /warning >}}

{{< readfile file="content/client/18/reusable/md/node_attribute_blocklist.md" >}}

### Attribute Allowlist

{{< warning >}}

{{< readfile file="content/client/18/reusable/md/node_attribute_allowlist_warning.md" >}}
...
{{< readfile file="content/client/18/reusable/md/config_rb_ohai.md" >}}

{{< readfile file="content/client/18/reusable/md/config_rb_ohai_settings.md" >}}
