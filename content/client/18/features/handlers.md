...
{{< readfile file="content/client/18/reusable/md/handler_type_exception_report.md" >}}

### Run from Recipes

{{< readfile file="content/client/18/reusable/md/handler_type_exception_report_run_from_recipe.md" >}}
...
{{< readfile file="content/client/18/reusable/md/handler_type_start.md" >}}

### Run from Recipes

{{< readfile file="content/client/18/reusable/md/handler_type_start_run_from_recipe.md" >}}
...
{{< readfile file="content/client/18/reusable/md/dsl_handler_summary.md" >}}

### on Method

{{< readfile file="content/client/18/reusable/md/dsl_handler_method_on.md" >}}

### Event types

{{< readfile file="content/client/18/reusable/md/dsl_handler_event_types.md" >}}
...
{{< readfile file="content/client/18/reusable/md/dsl_handler_slide_send_email.md" >}}

##### Define How Email is Sent

{{< readfile file="content/client/18/reusable/md/dsl_handler_slide_send_email_library.md" >}}

##### Add the Handler

{{< readfile file="content/client/18/reusable/md/dsl_handler_slide_send_email_handler.md" >}}

##### Test the Handler

{{< readfile file="content/client/18/reusable/md/dsl_handler_slide_send_email_test.md" >}}

#### etcd Locks

{{< readfile file="content/client/18/reusable/md/dsl_handler_example_etcd_lock.md" >}}

#### HipChat Notifications

{{< readfile file="content/client/18/reusable/md/dsl_handler_example_hipchat.md" >}}
...
By using the [chef_handler](/client/18/resources/bundled/chef_handler/) resource in a recipe, similar to the following:
...
{{< readfile file="content/client/18/reusable/md/handler_community_handlers.md" >}}
