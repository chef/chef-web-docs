...
{{< readfile file="content/client/18/reusable/md/unified_mode_overview.md" >}}

## Availability

{{< readfile file="content/client/18/reusable/md/unified_mode_client_releases.md" >}}

## Enable Unified Mode

{{< readfile file="content/client/18/reusable/md/unified_mode_enable.md" >}}
...
A simple motivating example is to have a resource that downloads a JSON message using the [remote_file](/client/18/resources/bundled/remote_file/) resource, parse the JSON using the [ruby_block](/client/18/resources/bundled/ruby_block/), and then render a value into a [file](/client/18/resources/bundled/file/) or [template](/client/18/resources/bundled/template/) resource.
...
{{< readfile file="content/client/18/reusable/md/unified_mode_actions_later_resources.md" >}}
...
{{< readfile file="content/client/18/reusable/md/unified_mode_troubleshooting.md" >}}
