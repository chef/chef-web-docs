...
{{< readfile file="content/client/18/reusable/md/config_rb_client_summary.md" >}}
...
: {{< readfile file="content/client/18/reusable/md/workstation/ctl_chef_client_options_format.md" >}}
...
: The path to a file that contains JSON data. Used to setup the first client run. The attributes will persist on Chef Infra Server for all future runs with option `-j`.
    ...
    **Run-lists**
    ...
    {{< readfile file="content/client/18/reusable/md/node_ctl_run_list.md" >}}
    ...
    **All attributes are normal attributes**
    ...
    {{< readfile file="content/client/18/reusable/md/node_ctl_attribute.md" >}}
...
{{< readfile file="content/client/18/reusable/md/workstation/knife_data_bag_from_file_create_encrypted_local_mode.md" >}}

## Run in FIPS Mode

{{< readfile file="content/client/18/reusable/md/fips_intro_client.md" >}}

**Bootstrap a node using FIPS**

{{< readfile file="content/client/18/reusable/md/workstation/knife_bootstrap_node_fips.md" >}}
...
{{< readfile file="content/client/18/reusable/md/workstation/ctl_chef_client_bootstrap_initial_run_list.md" >}}
