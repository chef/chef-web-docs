...
- Is mostly a collection of [resources](/client/18/resources/bundled/), defined using patterns (resource names, attribute-value pairs, and actions); helper code is added around this using Ruby, when needed
