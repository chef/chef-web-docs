...
mode](/client/18/resources/custom/unified_mode/) can also be used in the resource to eliminate compile/converge
...
The best approach to this problem is to use [`unified mode`](/client/18/resources/custom/unified_mode/), which eliminates
