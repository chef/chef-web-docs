...
{{< readfile file="content/client/18/reusable/md/server/chef_auth.md" >}}

## Authentication

{{< readfile file="content/client/18/reusable/md/server/chef_auth_authentication.md" >}}

### chef-validator

{{< readfile file="content/client/18/reusable/md/security_chef_validator.md" >}}

{{< readfile file="content/client/18/reusable/md/security_chef_validator_context.md" >}}

## SSL certificates

{{< readfile file="content/client/18/reusable/md/server/server_security_ssl_cert_client.md" >}}
...
{{< readfile file="content/client/18/reusable/md/workstation/knife_ssl_check_verify_server_config.md" >}}

##### Unverified

{{< readfile file="content/client/18/reusable/md/workstation/knife_ssl_check_bad_ssl_certificate.md" >}}
...
{{< readfile file="content/client/18/reusable/md/workstation/knife_ssl_fetch_verify_certificate.md" >}}
