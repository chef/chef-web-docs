...
The Chef Infra Client has the [same system requirements](/client/19/install/system_requirements/#chef-infra-client-requirements) on the AIX platform as any other platform, with the following notes:
...
See the [proxies](/client/19/install/proxies/) documentation for information on how to
