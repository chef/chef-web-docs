...
A |resource script_perl| resource block executes scripts |perl|:
...
The full syntax for all of the properties that are available to the |resource script_perl| resource is:
