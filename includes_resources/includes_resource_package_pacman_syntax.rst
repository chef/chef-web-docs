...
A |resource package_pacman| resource block manages a package on a node, typically by installing it. The simplest use of the |resource package_pacman| resource is:
...
The full syntax for all of the properties that are available to the |resource package_pacman| resource is:
