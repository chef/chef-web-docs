...
require (
	...
	github.com/chef/chef-workstation/docs-chef-io v0.0.0-20210325185229-f73ee34a0b4f // indirect
	...
	github.com/inspec/inspec/docs-chef-io v0.0.0-20210324191437-3091f5d6f0c6 // indirect
)
