...
require (
	...
	github.com/chef/cookstyle v7.10.1+incompatible // indirect
	...
	github.com/inspec/inspec v4.33.1+incompatible // indirect
	github.com/inspec/inspec/docs-chef-io v0.0.0-20210420184249-6e55c9ed90c2 // indirect
