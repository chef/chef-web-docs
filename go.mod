...
require (
	github.com/chef/automate/components/docs-chef-io v0.0.0-20201230191015-b7f616537843 // indirect
	...
	github.com/inspec/inspec/docs-chef-io v0.0.0-20210106210521-1ccaa3e482fd // indirect
)
