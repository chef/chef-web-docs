...
project = u'Chef Compliance Documentation'
...
html_title = "Chef Compliance Documentation"
...
html_last_updated_fmt = 'Chef Compliance'
...
htmlhelp_basename = 'Chef Compliance Documentation'
